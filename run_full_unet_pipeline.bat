...
echo [1/3] Generating zero-shot labels for 800 images (Est. 1.1 hours)
python src\training\run_zero_shot_label_pipeline.py
if %errorlevel% neq 0 (
    echo Zero-shot label generation failed!
    exit /b %errorlevel%
)
echo.
