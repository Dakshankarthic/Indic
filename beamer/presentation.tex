...
\begin{columns}
  ...
  \begin{column}{0.48\textwidth}
    ...
    \vspace{0.1cm}
    \footnotesize\textbf{Verification Overlay:} Stage 2 Text Line Boundaries
  \end{column}
\end{columns}
\end{frame}
...
\begin{columns}
  \begin{column}{0.48\textwidth}
    ...
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{stage3_acute_segment.jpg}
  \end{column}
  \begin{column}{0.48\textwidth}
    \centering
    \textbf{(b) Final Granular PAGE-XML Output}\\
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{stage3_final_output.jpg}
  \end{column}
\end{columns}
\vspace{0.2cm}
\footnotesize\textbf{Verification Overlay:} Granular extraction of word bounding boxes and Akshara glyph components.
\end{frame}
...
% ─────────────────────────────────────────────────────────────
% FRAME 17: Visual Pipeline Progression Across All Stages
% ─────────────────────────────────────────────────────────────
...
\centering
\includegraphics[width=\textwidth,height=0.68\textheight,keepaspectratio]{output_all_stages_progression.png}\\
\vspace{0.15cm}
\footnotesize\textbf{Pipeline Flow:} (1) Raw Input Capture $\rightarrow$ (2) DINOv2 \& nnU-Net Layout Regions $\rightarrow$ (3) Text Recognition $\rightarrow$ (4) Granular Word \& Akshara Bounding Boxes.
\end{frame}

% ─────────────────────────────────────────────────────────────
% FRAME 18: Visual Results: Standard Text Page (Page 1)
% ─────────────────────────────────────────────────────────────
\begin{frame}{Visual Results: Standard Text Page (Page 1)}{Side-by-Side Comparison of Original Folio vs. Annotated Output}
\begin{columns}
  \begin{column}{0.48\textwidth}
    \centering
    \textbf{Original Capture (Page 1)}\\
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{result_page1_orig.jpg}
  \end{column}
  \begin{column}{0.48\textwidth}
    \centering
    \textbf{Annotated Output (Page 1)}\\
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{result_page1_annot.jpg}
  \end{column}
\end{columns}
\vspace{0.2cm}
\footnotesize\textbf{Figure 1.5:} Multi-level annotations for standard text folios showing region, line, and word boundaries.
\end{frame}

% ─────────────────────────────────────────────────────────────
% FRAME 19: Visual Results: Dense Multi-Script Page (Page 100)
% ─────────────────────────────────────────────────────────────
\begin{frame}{Visual Results: Dense Multi-Script Page (Page 100)}{Side-by-Side Comparison on Complex Multi-Column Manuscript}
\begin{columns}
  \begin{column}{0.48\textwidth}
    \centering
    \textbf{Original Capture (Page 100)}\\
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{result_page100_orig.png}
  \end{column}
  \begin{column}{0.48\textwidth}
    \centering
    \textbf{Annotated Output (Page 100)}\\
    \vspace{0.2cm}
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{result_page100_annot.png}
  \end{column}
\end{columns}
\vspace{0.2cm}
\footnotesize\textbf{Figure 1.6:} Accurate separation of commentary text, central verse columns, and marginal notations.
\end{frame}

% ─────────────────────────────────────────────────────────────
% FRAME 20: Quantitative Recognition & Transcription Metrics
% ─────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────
% FRAME 21: Semantic Layout F1-Scores & Human Effort Reduction
% ─────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────
% FRAME 22: Summary of Technical Contributions & Conclusion
% ─────────────────────────────────────────────────────────────
\section{Conclusion}
